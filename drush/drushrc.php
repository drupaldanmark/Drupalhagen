...
$options['structure-tables']['common'] = array(
  ...
  'cache_admin_menu',
  'cache_bootstrap',
  'cache_entity_entity_collection',
  'cache_field',
  'cache_filter',
  'cache_form',
  'cache_image',
...
/**
 * overwrite domains used for language selection on your local environment.
 * used when running drush @local devify
 */
# $options['local-domains-per-language'] = array();
